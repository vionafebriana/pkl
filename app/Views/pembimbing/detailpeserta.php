                            ...
                            <table class="table m-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-sm btn-primary" href="/Pembimbing/bukaPengantar/<?= $user['id'] ?>" target="_blank"><span class="fa fa-eye"></span> Lihat</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Proposal</th>
                                        <td> <a class="btn btn-sm btn-primary" href="/Pembimbing/bukaProposal/<?= $user['id'] ?>" target="_blank"><span class="fa fa-eye"></span> Lihat</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
